...
public class PointcutExpressionTest {
    ...
    public void pointcut() throws Exception {
        ...
        tagetClassPointcutMatches("execution(* com.springbook.learningtest.spring.pointcut.Target.*(..))", true, true, true, true, true, false);
        tagetClassPointcutMatches("execution(* com.springbook.learningtest.spring.pointcut.*.*(..))", true, true, true, true, true, true);
        tagetClassPointcutMatches("execution(* com.springbook.learningtest.spring.pointcut..*.*(..))", true, true, true, true, true, true);
        tagetClassPointcutMatches("execution(* com.springbook..*.*(..))", true, true, true, true, true, true);

        tagetClassPointcutMatches("execution(* site..*.*(..))", false, false, false, false, false, false);
    ...
    public void methodSignaturePointcut() throws SecurityException, NoSuchMethodException {
        ...
        pointcut.setExpression(
                "execution(public int com.springbook.learningtest.spring.pointcut.Target.minus(int,int))");
